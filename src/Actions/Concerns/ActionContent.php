...
trait ActionContent {
   ...
   protected function formatActivityData($activity): array {
      $value = json_decode($activity->properties, true);
      ...
      return [
         ...
         'properties' => $this->formatDateValues($value),
         'batch_uuid' => $activity->batch_uuid,
         'update' => $activity->updated_at,
      ];
   }

   private static function formatDateValues(array|string|null|bool $value): array|string|null|bool {
      if (is_null($value)) {
         return $value;
      }
